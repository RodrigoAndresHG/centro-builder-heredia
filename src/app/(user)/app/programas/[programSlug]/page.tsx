      ...
      {isPresale ? (
        <WorkspaceHero
          ...
          description={
            ...
            "Tu acceso fundador ya quedó activo. El recorrido completo se abrirá oficialmente el 30 de mayo de 2026. Hasta entonces, estás entrando antes que el público general."
          }
        >
