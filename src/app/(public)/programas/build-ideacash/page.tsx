        ...
        <div className="relative rounded-xl border border-neutral-800 bg-neutral-950 p-5">
          ...
          <div className="mt-5 rounded-xl border border-teal-400/20 bg-teal-400/10 p-4">
            ...
            <p className="mt-2 text-xs leading-5 text-teal-100/80">
              Apertura oficial: jueves 4 de junio de 2026
            </p>
          </div>
        </div>
      </div>
          ...
          <div className="flex flex-col justify-center">
            <Reveal>
              ...
              <p className="mt-4 max-w-2xl text-base leading-8 text-neutral-400">
                ...
                Builder.rodriheredia.com. Abrirá el jueves 4 de junio de 2026.
              </p>
            </Reveal>
        ...
        <div className="mx-auto grid max-w-7xl gap-8 px-5 py-16 sm:px-6 lg:grid-cols-[1fr_0.8fr] lg:px-8">
          <div>
            <SectionIntro
              ...
              description="Build IdeaCash — Founder Access abrirá oficialmente el jueves 4 de junio de 2026. Si te unes ahora al acceso temprano, quedarás en la lista prioritaria para entrar con precio fundador y recibir el aviso del lanzamiento en vivo."
            />
